...
FROM
    ...
    RIGHT OUTER JOIN ds3_userdata.SU_Well_Sample_Props_Pivot t10 on t10.group_ID = t1.group_id                                                        
    INNER JOIN ds3_userdata.tm_protocols            t11 ON t11.protocol_id = t4.protocol_id
WHERE
        t11.protocol_id = 481
